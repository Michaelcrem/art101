...
//create a div element that has id="div_1" and text that says "Want know how many challenges we had"
...
//change the text from this annoying into "NONE!... ect." when Clicking the button
...
//create a div element that has id="div_1" and text that says "Don't press the button"
...
//change the text from this annoying into "I got 99 Problems, but JavaScript isn't one.....etc." when Clicking the button
...
//create a div element that has id="div_1" and text that says "DONT PRESS THE THIRD BUTTON!"
...
//change the text from this annoying into "Here we have our results... ect." when Clicking the button
